...
/**
 * Controls the exact message to be sent to a chat upon a completion of a build.
 *
...
public abstract class BuildToChatNotifier implements Describable<BuildToChatNotifier> {
    /**
     * Calculates the message to send out to a chatwhen the specified build is started.
     */
